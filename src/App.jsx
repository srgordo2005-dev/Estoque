...
export default function App(){
  ...
  return<div style={{background:C.bg,minHeight:"100vh",fontFamily:"'Inter',system-ui,sans-serif",color:C.text,maxWidth:960,margin:"0 auto"}}>
    ...
    <div style={{padding:"14px 12px 100px"}}>
      ...
      {tab==="guia"&&(p.repairs||p.testing||isAdmin)&&<GuiaTecnicoPage ctx={ctx}/>}
...
function GuiaTecnicoPage({ctx}) {
  const [activePage, setActivePage] = useState('p0'); // p0 to p8
  ...
  return <div className="guia-tecnico-wrap" style={{marginBottom:80}}>
    <style>{`
      .guia-tecnico-wrap {
        --bg:#07090f;--bg2:#0d1018;--bg3:#111520;--bg4:#0a0d16;
        --border:#1a2235;--border2:#222d45;
        --accent:#f7931a;--blue:#00d4ff;--green:#39ff14;--red:#ff3b3b;
        --purple:#cc44ff;--yellow:#ffe566;--orange:#ff8c00;
        --text:#c8d6e8;--dim:#5a6e88;--bright:#eaf2ff;
        --mono:'Share Tech Mono',monospace;--sans:'Inter',sans-serif;--display:'Orbitron',sans-serif;
        background: var(--bg);
        color: var(--text);
        padding: 16px;
        border-radius: 12px;
      ...
      .guia-tecnico-wrap .nav-tab.active { color: var(--accent); background: rgba(247,147,26,0.1); font-weight: 700; }
      ...
      .guia-tecnico-wrap .grid-2 { display: grid; grid-template-columns: 1fr 1fr; gap: 14px; }
      .guia-tecnico-wrap .grid-3 { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 12px; }
      .guia-tecnico-wrap .grid-4 { display: grid; grid-template-columns: repeat(4, 1fr); gap: 10px; }
      ...
      .guia-tecnico-wrap .tbl { width: 100%; border-collapse: collapse; font-size: 11px; }
      ...
      .guia-tecnico-wrap .tbl tr:hover td { background: rgba(247,147,26,0.02); }
      .guia-tecnico-wrap .tbl .ok { color: var(--green); }
      .guia-tecnico-wrap .tbl .warn { color: var(--accent); }
      .guia-tecnico-wrap .tbl .bad { color: var(--red); }
      ...
      .guia-tecnico-wrap .chip:hover { transform: scale(1.15); z-index: 10; }
      ...
      .guia-tecnico-wrap .chip-label { font-size: 8px; color: rgba(255,255,255,0.85); pointer-events: none; }
      ...
      .guia-tecnico-wrap .link-list { display: flex; flex-direction: column; gap: 8px; }
      ...
      .guia-tecnico-wrap .linfo .ltitle { color: var(--bright); font-size: 11.5px; font-weight: 700; }
      .guia-tecnico-wrap .linfo .ldesc { color: var(--dim); font-size: 10.5px; margin-top: 1px; }
      .guia-tecnico-wrap .linfo .lurl { display: block; color: var(--blue); font-size: 9px; margin-top: 3px; text-decoration: none; }

      .guia-tecnico-wrap .tag { display: inline-block; font-size: 9px; padding: 2px 6px; border-radius: 3px; margin: 2px; }
      ...
      .guia-tecnico-wrap .pcb-wrap { display: flex; gap: 14px; align-items: flex-start; }
      .guia-tecnico-wrap .pcb-side { flex: 1; min-width: 0; }
      .guia-tecnico-wrap .pcb-info { width: 230px; flex-shrink: 0; background: var(--bg2); border: 1px solid var(--border); border-radius: 6px; overflow: hidden; }
      .guia-tecnico-wrap .pi-title { font-size: 9px; color: var(--accent); letter-spacing: 1px; padding: 8px 12px; border-bottom: 1px solid var(--border); background: var(--bg3); }
      .guia-tecnico-wrap .pi-body { padding: 12px; }
      .guia-tecnico-wrap .pi-num { font-size: 20px; font-weight: 900; color: var(--green); }
      .guia-tecnico-wrap .pi-sub { font-size: 9px; color: var(--dim); margin-bottom: 8px; }
      .guia-tecnico-wrap .pi-row { display: flex; justify-content: space-between; padding: 4px 0; border-bottom: 1px solid rgba(30,41,64,0.2); font-size: 9.5px; }
      ...
      .guia-tecnico-wrap .pi-hint { font-size: 8.5px; color: var(--dim); line-height: 1.5; margin-top: 8px; padding-top: 8px; border-top: 1px solid var(--border); }
      
      .guia-tecnico-wrap .ctrl-bar { display: flex; align-items: center; gap: 6px; padding: 8px 0; flex-wrap: wrap; }
      ...
      .guia-tecnico-wrap .btn-sm.active { background: rgba(247,147,26,0.1); border-color: var(--accent); color: var(--accent); }
      ...
      .guia-tecnico-wrap .msel.active { background: rgba(247,147,26,0.1); border-color: var(--accent); color: var(--accent); }

      .guia-tecnico-wrap .sig-legend { display: flex; gap: 6px; flex-wrap: wrap; margin-bottom: 8px; }
      ...
      .guia-tecnico-wrap .sig-dot { width: 6px; height: 6px; border-radius: 50%; }
      ...
      .guia-tecnico-wrap .ftree { font-size: 11px; line-height: 1.8; padding: 8px; }
      ...
      .guia-tecnico-wrap .ft-indent { padding-left: 16px; }
      .guia-tecnico-wrap .ft-desc { color: var(--dim); font-size: 9px; margin-left: 6px; }

      .guia-tecnico-wrap .sig-diagram { background: var(--bg3); border: 1px solid var(--border); border-radius: 4px; padding: 12px; font-size: 10px; overflow-x: auto; }
      .guia-tecnico-wrap .srow { display: flex; align-items: center; margin: 6px 0; gap: 6px; }
      .guia-tecnico-wrap .sname { width: 44px; font-weight: bold; flex-shrink: 0; }
      .guia-tecnico-wrap .svolt { font-size: 8px; background: rgba(0,0,0,0.3); padding: 1px 4px; border-radius: 6px; border: 1px solid rgba(255,255,255,0.06); }

      .guia-tecnico-wrap .dom-viz { display: flex; flex-direction: column; gap: 3px; font-size: 10px; }
      .guia-tecnico-wrap .dom-row { display: flex; align-items: center; gap: 4px; }
      .guia-tecnico-wrap .dom-lbl { width: 60px; color: var(--dim); font-size: 8px; flex-shrink: 0; }
      .guia-tecnico-wrap .dom-chips { display: flex; gap: 2px; }
      ...
      .guia-tecnico-wrap .dom-volt { color: var(--blue); font-size: 8px; margin-left: 4px; }
      ...
      .guia-tecnico-wrap .psu-val { font-size: 14px; font-weight: 900; color: var(--accent); }
      .guia-tecnico-wrap .psu-lbl { font-size: 8px; color: var(--dim); margin-top: 1px; }
      .guia-tecnico-wrap .psu-arrow { font-size: 16px; color: var(--accent); }
      .guia-tecnico-wrap .psu-flow { display: flex; align-items: center; gap: 4px; margin: 6px 0; flex-wrap: wrap; justify-content: center; }
    `}</style>
  ...
  └─ IO Cable ──→ HASHBOARDS (CLK, TX, RX, RST, BO)`}
    ...
    {activePage==='p1' && <div>
      ...
      <div className="ctrl-bar" style={{marginBottom:10}}>
        <span style={{fontSize:9,color:C.muted}}>SELECIONE MODELO:</span>
      ...
      <div className="pcb-wrap">
        <div className="pcb-side">
              ...
              {pos.map((p,i) => {
                ...
                return (
                  <div
                    ...
                    onClick={()=>selectChip(i,m, {classList:{add:()=>{},remove:()=>{}}})}
                  >
          ...
          <div className="ctrl-bar" style={{marginTop:10}}>
            ...
            <span style={{fontSize:10,color:C.green,marginLeft:8}}>
        ...
        <div className="pcb-info">
          ...
          <div className="pi-body" id="chipInfo">
            {selChip!==null ? (
              ...
              <div style={{color:'var(--dim)',fontFamily:'monospace',fontSize:10,textAlign:'center',padding:'20px 0'}}>
...
3. Checar sinal CLK no pino de teste do chip 01:
   ...
   └─ OK: Checar sinal RST e TX da controladora (nível lógico 1.8V/1.2V).`}
    ...
    {/* P8 - ANÁLISE DE LOGS (NEW CUSTOM TAB) */}
    {activePage==='p8' && <div>
