...
if (startIndex !== -1 && endIndex !== -1) {
   ...
   // Now we must close the ternary AT THE END of DataCenterPage.
   // Wait, if I am wrapping the rest of DataCenterPage in `) : ( ...`, I need to find the `return <div style={{padding: 20}}>...</div>;`
   // The end of the DataCenterPage component looks like this:
   //             })
   //          )}
   //      </div>;
   // }
...
console.log("APPLIED CAREFUL REWRITE!");
